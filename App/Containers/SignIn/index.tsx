                    ...
                    <View style={styles.mEndThen}>
                        <View style={styles.mLoginBox}>
                            ...
                            <View style={styles.mBoxPassword}>
                                <Input typeInput={'symbol'} statusInput={'password'} error={statusMessagePassWord}
                                    textError={messagePassWord}
                                    onEndEditing={(event) => {
                                        onChangePassWordInput(event.nativeEvent.text);
                                    }
                                    } iconName={icons.ic_key} placeholderText={`${t('sign_in.password')}`}
                            ...
                            <View style={styles.mWrapLogin}>
                                <Button text={t('sign_in.sign_in')} typeButton={'primary'} sizeButton={'large'}
                                    onPressButton={onLogin}/>
                            </View>
                            <Text style={styles.mTextUnderButton}>{t('passRecovery.option')}</Text>
                            <View style={{justifyContent: 'space-between'}}>
                                ...
                                <View>
                                    <TouchableOpacity style={styles.mViewForgot} onPress={() => {
                                        navigation.navigate('PasswordRecovery');
                                    }}>
                                        <Text style={styles.mTextForgot}>{t('sign_in.forgot')}</Text>
