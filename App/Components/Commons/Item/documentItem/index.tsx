...
export const ItemMyDocument = (props: itemInterface) => {
    const {t} = useTranslation();
    const {token} = useSelector((state: RootState) => ({
        token: state.auth.auth.token,
    }));
    console.log(props.itemData);
    console.log(`${LINK_IMAGE + '?documentId='+ props.itemData.documentId+ '&token='+token}`);

    const formatDate = moment(props.itemData?.createdDate).format('DD/MM/YYYY');
        ...
        <TouchableOpacity
            ...
            <View style={styles.cContainer}>
                ...
                <View style={styles.mRowTop}>
                    ...
                    <View style={styles.mColum}>
                        ...
                        <Text
                            ...
                            numberOfLines={2}
                            ellipsizeMode={'tail'}>
                            {`${props.itemData?.documentCode}` +
                '-' +
                `${props.itemData?.documentName}`}
                        </Text>
                    </View>
                    {/*Phần icon option*/}
                    <TouchableOpacity
                        style={styles.mColumIcon}
                        onPress={props.onHandleOption}>
                        <Image
                ...
                <View style={styles.mRowBottom}>
                    {/*Text date*/}
                    <Text style={styles.mTextDate}>{formatDate}</Text>
                    {/*Phần trạng thái*/}
                    <Text>
                        {/*Trạng thái chờ ký*/}
    ...
    // trạng thái list or view
        <TouchableOpacity
            ...
            <View style={styles.cContainerV}>
                ...
                <View style={styles.mRowBottom}>
                    {/*Text date*/}
                    <Text style={styles.mTextDateV}>{formatDate}</Text>
                    {/*Phần trạng thái*/}
                    <Text>
                        {/*Trạng thái chờ ký*/}
                        {props.itemData.status == DocumentStatus.SIGNING ? (
